...
// display boundary - query ingest, file parse - runs through
// DecodeSubject; the raw form stays only in the h-key header block
// and the cache keys.
...
// charset words keep the raw text: a display wart beats a lost subject.
